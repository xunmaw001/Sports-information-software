    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="商品简介" prop="shangpinjianjie">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shangpinjianjie" label="商品简介" prop="shangpinjianjie">
                    <span v-html="ruleForm.shangpinjianjie"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.shangpinjianjie = this.ruleForm.shangpinjianjie.replace(reg,'../../../ssm39lil/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
