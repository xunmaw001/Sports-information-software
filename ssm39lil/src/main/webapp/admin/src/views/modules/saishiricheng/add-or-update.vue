<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="轮次" prop="lunci">
          <el-input v-model="ruleForm.lunci" 
              placeholder="轮次" clearable  :readonly="ro.lunci"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="轮次" prop="lunci">
              <el-input v-model="ruleForm.lunci" 
                placeholder="轮次" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="主队" prop="zhudui">
          <el-input v-model="ruleForm.zhudui" 
              placeholder="主队" clearable  :readonly="ro.zhudui"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="主队" prop="zhudui">
              <el-input v-model="ruleForm.zhudui" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="客队" prop="kedui">
          <el-input v-model="ruleForm.kedui" 
              placeholder="客队" clearable  :readonly="ro.kedui"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="客队" prop="kedui">
              <el-input v-model="ruleForm.kedui" 
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="赛况" prop="saikuang">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="赛况"
                  v-model="ruleForm.saikuang" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.saikuang" label="赛况" prop="saikuang">
                    <span>{{ruleForm.saikuang}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `saishiricheng/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.saishirichengCrossAddOrUpdateFlag = false;
                  this.parent.search();
