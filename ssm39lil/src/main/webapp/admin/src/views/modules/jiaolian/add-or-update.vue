<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="教练国籍" prop="jiaolianguoji">
          <el-input v-model="ruleForm.jiaolianguoji" 
              placeholder="教练国籍" clearable  :readonly="ro.jiaolianguoji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="教练国籍" prop="jiaolianguoji">
              <el-input v-model="ruleForm.jiaolianguoji" 
                placeholder="教练国籍" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiaolianxingming = true;
          ...
          if(o=='jiaolianguoji'){
            this.ruleForm.jiaolianguoji = obj[o];
	    this.ro.jiaolianguoji = true;
            continue;
          }
          if(o=='ruzhiriqi'){
